...
Open SteaMidra, go to the **Home** tab, click **Auto LC Setup**, then click **Install LumaCore**. The Windows release already includes the LumaCore files, so SteaMidra copies them into the Steam folder and cleans up any leftover legacy injector files automatically.
